<x-app-layout :title="'Tambah Lokasi Patroli'">
    <div class="container mx-auto p-4">
        <h2 class="text-2xl font-bold mb-6 text-gray-800">Tambah Lokasi Patroli</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="latitude" name="latitude" value="{{ old('latitude') }}" required
                            readonly class="mt-1 block w-full rounded-lg border border-gray-300 shadow-sm text-sm">
                        @error('latitude')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
