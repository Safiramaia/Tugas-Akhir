<x-app-layout :title="'Riwayat Patroli'">
    <div class="container mx-auto p-4">
        <h2 class="text-2xl font-bold mb-6 text-gray-800">Riwayat Patroli Petugas</h2>
        ...
        <div class="overflow-x-auto border border-gray-200 rounded-lg shadow-md mb-4">
            <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4 px-4 py-3 bg-white">
                <form action="{{ route('unit.riwayat-patroli-petugas') }}" method="GET"
        ...
        <div class="overflow-x-auto border border-gray-200 rounded-lg shadow-lg mb-4">
            <table class="table-auto w-full text-sm text-gray-700">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <td class="px-4 py-2">
                                @if ($data->foto && file_exists(public_path('storage/' . $data->foto)))
                                    <img src="{{ asset('storage/' . $data->foto) }}" alt="Foto"
                                        class="w-20 h-auto mx-auto rounded shadow cursor-pointer"
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="px-4 py-4 text-center text-gray-500">Belum ada data patroli.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
